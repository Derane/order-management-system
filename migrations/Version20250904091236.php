 ...
 */
final class Version20250904091236 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_items (id SERIAL NOT NULL, order_id INT NOT NULL, product_name VARCHAR(255) NOT NULL, quantity INT NOT NULL, price NUMERIC(12, 2) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_62809DB08D9F6D38 ON order_items (order_id)');
        $this->addSql('CREATE TABLE orders (id SERIAL NOT NULL, customer_name VARCHAR(180) NOT NULL, customer_email VARCHAR(180) NOT NULL, total_amount NUMERIC(12, 2) NOT NULL, status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IF EXISTS idx_orders_customer_email');
